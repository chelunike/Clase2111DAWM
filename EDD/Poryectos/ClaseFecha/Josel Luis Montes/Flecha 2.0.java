...
public class Flecha {
    ...
    public String hoy(){
        return " "+Flecha.diaSemana(this)+", "+this.getDia()+" de "+this.mesAño(mes)+" de "+año;
    }
