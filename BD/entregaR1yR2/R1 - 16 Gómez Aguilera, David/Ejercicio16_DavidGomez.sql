...
insert into equipo
 values('ATM','Atlético de Madrid','Estadio Metropolitano',67829,'Madrid','2017-09-16',004)
select * from equipo
...
insert into presidente
 values('11111111f','Tito Floren','Pérez','1947-03-08','Real Madrid',2009)
insert into presidente
 values('22222222w','Josep Maria','Bartomeu','1963-02-06','Barcelona',2015)
insert into presidente
 values('33333333z','Enrique','Cerezo','1948-02-27','Atlético de Madrid',2003)
