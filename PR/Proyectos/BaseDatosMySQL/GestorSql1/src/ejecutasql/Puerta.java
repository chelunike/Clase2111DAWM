...
public class Puerta extends JFrame {
    ...
    private void init(){
        ...
        tabla.setTableChangeListener(new TableModelListener() {
            ...
            public void tableChanged(TableModelEvent evt){
                int n1 = evt.getType();
                int n2 = evt.getFirstRow();
                int n3 = evt.getColumn();
                int n4 = evt.getLastRow();
                System.out.println("\tTable Changed: type: "+n1+", FirstRow; "+n2+", Column; "+n3+", LastRow; "+n4);
            }
        });
    ...
    public void actualizaTabla(){
        try{
            ...
            if(n>=0){
                ...
                this.tabla.rentablaLaTabla(sql.getColumnsNames(rs), sql.getRawData(rs));
            }
    ...
    public void actualizaInfoTabla(){
