...
//STEP 5: Execute a query
			...
			/*
			SELECT idEmp,v.idArt,nombre, ppu, unidades, unidades*ppu importe , fecha from ventas v inner join articulos a on a.idArt= v.idArt order by v.idart 
			*/
...
//Ensure we start with first row 
	...
	public static void totalizaIdArt() throws SQLException {
		...
		while (bueno) {
			...
			while ( idArtAux == rs.getInt("idArt")&&bueno ) {
