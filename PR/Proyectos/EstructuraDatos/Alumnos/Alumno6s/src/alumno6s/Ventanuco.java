 ...
 * @author yo
 */
public class Ventanuco extends JFrame implements ActionListener, WindowListener {
    ...
    public Ventanuco(Contenedor cont){
        ...
        matriculaPn = new MatriculaPanel(Alumno.Asignaturas);
