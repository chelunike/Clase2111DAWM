...
public class Ventanuco extends JFrame implements ActionListener {
    ...
    private InsertarPanel insertarPn;
    private InsertarPanel modificarPn;//NUEVO
    ...
    private void init(){
        ...
        insertarPn = new InsertarPanel(this);
        modificarPn = new InsertarPanel(this);//Nuevo
        ...
        //-------------------------NUEVO-----------------------
        insertarPn.setTitle("Insertar Nuevo Alumno");
        modificarPn.setTitle("Modificar Alumno");
        modificarPn.setGuardarNombre("Editar");
        ...
        save.addActionListener(new EventoEditar());
    ...
    public void setBotonesEnabled(boolean b){
        this.anterior.setEnabled(b);
        this.siguiente.setEnabled(b);
        this.insert.setEnabled(b);
        this.save.setEnabled(b);
        this.isPrimero.setEnabled(b);
        this.isSegundo.setEnabled(b);
        this.notasBt.setEnabled(b);
        this.matriculaBt.setEnabled(b);
        this.orNombreRb.setEnabled(b);
        this.orFechaRb.setEnabled(b);
    }
    
    //Nos Ocupamos de los Botones
    @Override
    public void actionPerformed(ActionEvent e) {
        insertarPn.insertarAlumnoNuevo();
    }
    ...
    private class EventoEditar implements ActionListener{
        @Override
        public void actionPerformed(ActionEvent e) {
            Alumno actual = (Alumno)listaAlumnos.getPersona(select);
            modificarPn.modificarAlumno(actual);
        }
    }
