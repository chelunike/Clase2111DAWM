...
//////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        */
        ...
        Escuela.say(pr.insertaOrden(yo));
        pr.insertaOrden(Manu);
        pr.insertaOrden(Jozemi);
        pr.insertaOrden(Pocoyo);
        pr.insertaOrden(David);
        pr.insertaOrden(Placido);
        
        
        //yo.ordenar();
        System.out.println("Lista Alumnos: "+pr.toString());
        
        System.out.println(pr.listadoAlumAsig());
...
//////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public static Alumno leerAlumn(){
        ...
        System.out.println("El resto se hace de manera casi aleatoria :) ");
        
        String[] asig = {"Literatura","Matemáticas","Dibujo Tec","Historia","Tecnologia",
            "Religion","Programacion", "Lectura", "Fisolofia"};
        //Aleatorio = zapatos
        String[] tnp = new String[numa];
        double[] tmp = new double[numa];
        for(int i = 0; i<numa; i++){
            tnp[i]= asig[i];
